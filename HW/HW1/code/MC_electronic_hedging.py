...
def simulate_one_path():
    ## This is for experiment to get a vector of PNL
    ...
    delta_limit = 0.5  # units, assuming it is positive 
    hedge_target = 0
    ...
    print "pnl including hedging pnl", pnl_vec

    pnl_vec[1:len(pnl_vec)] += pos[:len(pos)-1] * dS
    
    print "Total PNL is ", pnl_vec
